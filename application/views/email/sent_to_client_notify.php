...
<table width="550" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="background:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td>&nbsp;</td>
        <td height="30" align="left"><strong>Dear '.$cust_name.',</strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        <td colspan="3" style="background-color:#e2ecf4;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="30" align="left" style="padding-left:20px;">&nbsp;</td>
            <td align="left">&nbsp;</td>
          </tr>
        
        <tr>
            <td height="30" align="left" style="padding-left:20px;"><strong>Download Audio:</strong></td>
            <td align="left">Please log into your client account to download this audio. '. BASEURL . '</td>
          </tr>
          <tr>
                <tr>
            <td height="10" colspan="2" align="left" style="padding-left:20px;">&nbsp;</td>
