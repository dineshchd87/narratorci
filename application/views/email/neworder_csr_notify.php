...
<table width="550" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="background:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="15" ><img src="http://www.narratorfiles.com/orders/images/narrow_files_logo_1px.gif" width="365" height="15" alt="logo" />
                    </td>
                  </tr>
                </table>
                </td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td height="30" align="left"><strong>Dear '.$csrFname.',</strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td></td>
      ...
      <tr>
        <td colspan="3" style="background-color:#e2ecf4;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="74%" align="left">'.$order_id.' (<em>'.$proname.'</em>)</td>
            </tr>
          <tr>
            <td height="30" align="left" valign="middle" style="padding-left:20px;">Customer:</td>
            <td align="left">'.$customerName.'</td>
            </tr>
          <tr>
            <td height="30" align="left" style="padding-left:20px;">Date:</td>
            <td align="left">'.date("dS M Y " , $date).'</td>
            </tr>
          <tr>
            <td height="30" align="left" style="padding-left:20px;">Account Manager:</td>
            <td align="left">'.$csrFname.' '.$csrLname.'</td>
            </tr>
          <tr>
            <td height="10" colspan="2" align="left" style="padding-left:20px;">&nbsp;</td>
          </tr>
